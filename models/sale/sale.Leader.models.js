...
const SaleLeaderSchema = new mongoose.Schema({
...
SaleLeaderSchema.methods.generateAuthToken = function () {
...
const SaleLeader = mongoose.model("SaleLeader", SaleLeaderSchema);

const validateSaleLeader = (data) => {
...
module.exports = { SaleLeader, validateSaleLeader };
