...
exports.GetAllEmploeSamples = async (req, res) => {
  try {
    const employee = await Employee.find({
      employee_sub_department: "เเผนกเก็บตัวอย่าง",
    });
...
exports.EditEmployeeSamples = async (req, res) => {
  try {
...
exports.deleteSamplesByDepartment = async (req,res) =>{
  try {
    const id = req.params.id;
    ...
    if (employee.employee_sub_department !== "เเผนกเก็บตัวอย่าง") {
...
exports.deleteSamplesBy = async (req,res) =>{
  try {
    const id = req.params.id;
